...
const CVPreview: React.FC<props>=({personalDetails,file,theme,experiences,educations, languages,skills,hobbies
    ...
    return(
        <div ref={ref} className={`flex p-16 w-[950px] h-[1200px] shadow-lg
        ${download?'mb-10':""}
        `} data-theme={theme}>
          <div className="flex flex-col w-1/3">
             <div className="h-80 rounded-full overflow-hidden border-8 border-primary">
                   {
                    file && (
                        <Image
                        ...
                        <li className="step step-primary" key={index}>
                             <div className="text-left">
                                <h2 className="flex text-md uppercase font-bold">
                                    ...
                                    <span className="ml-2">{experiences.jobTitle}</span>
                                </h2>
                                <div className="tex-sm my-2">
                                    <span
                                    ...
                                    >{formatDate(experiences.startDate)}{" "} au{" "}
